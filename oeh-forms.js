...
if (location.pathname.replace(/\/$/, "") === "/results") {
  setTimeout(function () {
    ...
    css.textContent = ''
      ...
      + '#oeh-match-page{position:fixed;inset:0;z-index:2147483646;background:#f5f7f8;overflow:auto;font-family:Inter,Arial,Helvetica,sans-serif;color:#1c2430}'
      + '.oeh-bar{height:36px;display:flex;align-items:center;justify-content:center;gap:8px;background:#1b3344;color:#d5dde3;font-size:12px}'
      + '.oeh-bar-ic{width:14px;height:14px;border:1.5px solid #d5dde3;border-radius:99px;box-sizing:border-box}'
      + '.oeh-hd{height:72px;display:flex;align-items:center;justify-content:space-between;padding:0 40px;background:#fff}'
      ...
      + '.oeh-logo b{color:#1a1a1a}.oeh-logo .en,.oeh-m-word .en{color:#ED5D09}.oeh-logo .he,.oeh-m-word .he{color:#8d8d8d}'
      ...
      + '.oeh-m{max-width:760px;margin:0 auto;padding:48px 24px 64px}'
      ...
      + '.oeh-m h2{margin:0;font-size:44px;line-height:1.1;font-weight:700;letter-spacing:-0.03em;color:#1a2332}'
      + '.oeh-m-sub{margin:12px 0 0;color:#667085;font-size:16px;line-height:1.45}'
      + '.oeh-m-card{margin-top:28px;background:#fff;border:1px solid #e7eaee;border-radius:12px}'
      ...
      + '.oeh-m-score:after{content:"";display:block;width:88px;height:3px;margin-top:10px;background:#ED5D09;border-radius:2px}'
      ...
      + '.oeh-m-next a{flex:0 0 auto;display:inline-flex;align-items:center;gap:8px;height:44px;padding:0 18px;border-radius:8px;background:#ED5D09;color:#fff;font-weight:700;font-size:14px;text-decoration:none;white-space:nowrap}'
